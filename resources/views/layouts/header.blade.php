  ...
  <header id="header" class="d-flex flex-column justify-content-center">
      ...
      <nav id="navbar" class="navbar nav-menu">
          <ul>
              ...
              <li><a href="#about" class="nav-link scrollto"><i class="bx bx-file-blank"></i> <span>Data
                          Mentah</span></a>
              </li>
              <li><a href="#resume" class="nav-link scrollto"><i class="bx bx-map"></i> <span>Map</span></a></li>
